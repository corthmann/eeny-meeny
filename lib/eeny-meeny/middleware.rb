  ...
  class Middleware
    ...
    def call(env)
      ...
      @experiments.each do |experiment|
        ...
        has_experiment_trigger = EenyMeeny.config.query_parameters[:experiment] && request.params.key?(cookie_name)
      ...
      if EenyMeeny.config.query_parameters[:smoke_test]
        if request.params.key?('smoke_test_id') && (request.params['smoke_test_id'] =~ /\A[A-Za-z_]+\z/)
